  ...
  return (
    <div className="relative bg-dark rounded-3xl overflow-hidden px-10 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
      <div className="text-white text-center md:text-right">
        <p className="red text-xs font-bold uppercase tracking-widest mb-2">
          پیشنهاد ویژه
        </p>
      ...
      <Link
        to="/products"
        className="bg-red whitespace-nowrap text-white font-bold px-8 py-3 rounded-full hover:opacity-90 transition-opacity"
      >
        همین حالا عضو شو
      </Link>
